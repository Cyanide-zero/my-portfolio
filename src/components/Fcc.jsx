    ...
    <>
      ...
      <div className={FCC.mainContainer}>
        <div className={FCC.contentContainer}>
          <a
            href="https://codepen.io/TetraCyanide/full/JjvorKB"
            target="_blank"
          ...
          <a
            href="https://codepen.io/TetraCyanide/full/JjvdMXK"
            target="_blank"
            className={FCC.linkContainer}
          >
          ...
          <a
            href="https://codepen.io/TetraCyanide/full/ZEoGvaY"
            target="_blank"
            className={FCC.linkContainer}
          >
          ...
          <a
            href="https://www.freecodecamp.org/certification/Cyanide-zero/front-end-development-libraries"
            target="_blank"
            className={FCC.linkContainer}
            style={{ marginTop: "1vh" }}
          >
        ...
        <div className={FCC.contentContainer}>
          <a
            href="https://boilerplate-project-timestamp.cyanide-zero.repl.co/"
            target="_blank"
            className={FCC.linkContainer}
          >
          ...
          <a
            href="https://boilerplate-project-headerparser.cyanide-zero.repl.co/"
            target="_blank"
            className={FCC.linkContainer}
          >
          ...
          <a
            href="https://boilerplate-project-urlshortener.cyanide-zero.repl.co/"
            target="_blank"
            className={FCC.linkContainer}
          >
          ...
          <a
            href="https://boilerplate-project-exercisetracker.cyanide-zero.repl.co/"
            target="_blank"
            className={FCC.linkContainer}
          >
          ...
          <a
            href="https://boilerplate-project-filemetadata.cyanide-zero.repl.co/"
            target="_blank"
            className={FCC.linkContainer}
          >
          ...
          <a
            href="https://www.freecodecamp.org/certification/Cyanide-zero/back-end-development-and-apis"
            target="_blank"
            className={FCC.linkContainer}
            style={{ marginTop: "1vh" }}
          >
            <p className={FCC.linkText}>
      ...
      {prof === true ? (
        <form className={FCC.form} onSubmit={handleSubmit}>
          {code === "CMPE30213" ? (
            ...
            <>
              <label className={FCC.inputLabel}>
                Enter the Subject Code:{" "}
                <span style={{ color: "#0c0c0c" }}>CMPE30213</span>
              </label>
              <input
                type="text"
                className={FCC.inputField}
                onChange={(e) => {
        ...
        <div>
          ...
          <div id="eyes" className={FCC.eyes}>
            <img
              className="eye"
              src={eye}
              style={{ position: "absolute", top: "32vh", left: "39.5vw" }}
            />
            <img
              className="eye"
              src={eye}
              style={{ position: "absolute", top: "32vh", left: "56.5vw" }}
            />
